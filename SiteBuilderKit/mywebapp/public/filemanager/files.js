var Files = (function () {
  ...
  class Files {
        ...
        <div class="panel">
            ...
            <div class="panel-side">
                ...
                <div class="tab-content tab-content-generate-image" role="tabpanel">
                    ...
                    <option value="stable-diffusion-xl-v1-0">Stable Diffusion XL</option>
                    <option value="realistic-vision-v1-3-inpainting">Realistic Vision v1.3 Inpainting</option>
                    <option value="stable-diffusion-v1-5-inpainting">Stable Diffusion Inpainting v1.5</option>
                    <option value="gfpgan-v1-3">GFPGAN v1.3</option>
                    <option value="real-esrgan-4x">Real-ESRGAN</option>
                    <option value="instruct-pix2pix">Instruct Pix2Pix</option>
                    -->
                    ...
                    <input id="inpNegPrompt" type="text" class="inp-neg-prompt p-2 rounded mb-4" value=""></input>
    ...
    viewMedia(url) {
      ...
      if (ext === 'jpg' || ext === 'png' || ext === 'gif' || ext === 'webp' || ext === 'bmp' || ext === 'tiff' || ext === 'mp4' || ext === 'mov' || ext === 'mp3' || ext === 'pdf' || ext === 'txt' || ext === 'css' || ext === 'js' || ext === 'html' || ext === 'md' || ext === 'svg' || ext === 'json') ; else {
        return;
      }
      ...
      if (ext === 'jpg' || ext === 'png' || ext === 'gif' || ext === 'webp' || ext === 'bmp' || ext === 'tiff') {
    ...
    async renderObjects(iconsOnly) {
      ...
      this.objects.forEach(item => {
        ...
        if (item.type === 'folder') {
          ...
          if (!iconsOnly && (ext === 'jpg' || ext === 'png' || ext === 'gif' || ext === 'webp' || ext === 'bmp' || ext === 'tiff')) {
            // Image
          ...
          if (ext === 'jpg' || ext === 'png' || ext === 'gif' || ext === 'webp' || ext === 'bmp' || ext === 'tiff' || ext === 'mp4' || ext === 'mov' || ext === 'mp3' || ext === 'pdf') {
            // Zoom in button
